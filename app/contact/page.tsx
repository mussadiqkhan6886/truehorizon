        ...
        <div className='flex min-h-screen flex-col gap-4 px-2 sm:px-0'>
          ...
          <form className='p-3 rounded-lg mb-6 border gap-2 border-zinc-800 grid grid-cols-2'>
            ...
            <div className="flex flex-col gap-2">
              ...
              <input type="email" id='email' className='outline-none border border-zinc-800 p-2 text-zinc-200' />
            </div>
            <div className="flex flex-col gap-2">
              <label className='text-sm mt-1' htmlFor="companySite">Company Site</label>
              <input type="text" id='companySite' className='outline-none border border-zinc-800 p-2 text-zinc-200' />
            </div>
            <div className="flex flex-col gap-2">
              <label className='text-sm mt-1' htmlFor="phone">Phone</label>
              <input type="phone" id='phone' className='outline-none border border-zinc-800 p-2 text-zinc-200' /></div>
            <div className="flex flex-col gap-2">
              <label className='text-sm mt-1' htmlFor="companyName">Company Name</label>
              <input type="text" id='companyName' className='outline-none border border-zinc-800 p-2 text-zinc-200' />
            </div>
            <div className="flex flex-col gap-2">
              <label className='text-sm mt-1' htmlFor="companySize">Company Size</label>
              <input type="text" id='companySize' className='outline-none border border-zinc-800 p-2 text-zinc-200' />
            </div>
            <div className="flex flex-col gap-2">
              <label className='text-sm mt-1' htmlFor="revenue">Company Annual Revenue</label>
              <input type="text" id='revenue' className='outline-none border border-zinc-800 p-2 text-zinc-200' />
            </div>
            <div className="flex flex-col gap-2 col-span-2">
              <label className='text-sm mt-1' htmlFor="projectBudget">Project Budget</label>
              <input type="text" id='projectBudget' placeholder='$10k-$50k' className='outline-none border border-zinc-800 p-2 text-zinc-200' />
            </div>
            <div className='col-span-2 flex flex-col gap-2'>
              <label className='text-sm mt-1' htmlFor="services">What services are you looking for</label>
              <textarea id='services' className='outline-none border border-zinc-800 p-2 text-zinc-200' />
            </div>
            <div className='col-span-2 flex flex-col gap-2'>
              <label className='text-sm mt-1' htmlFor="message">Message</label>
              <textarea  id='message' placeholder='Hi, I am jane I want help with...' className='outline-none border border-zinc-800 p-2 text-zinc-200'/>
            </div>
