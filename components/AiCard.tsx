  ...
  return (
    <div className='relative h-[159px] border border-gray-800'>
      ...
      <div className='z-10 bg-zinc-900 w-[26px] h-[134px] left-0 bottom-0 absolute'>
        ...
        <div className="h-[87%] md:h-[80%] text-white  rounded-md flex flex-col antialiased items-end pr-3 md:pr-0 justify-end md:items-center md:justify-center relative overflow-hidden">
              <InfiniteMovingCode 
                items={<CodeBlock />}
                direction="up"
                speed="fast"
