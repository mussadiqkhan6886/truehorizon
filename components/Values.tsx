    ...
    <section className='my-10 max-w-4xl relative mx-auto'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 px-1 gap-5 z-10'>
            {valuesAbout.map(item => (
                <motion.div variants={variants2(item.delay)} initial="hidden" whileInView={"show"} key={item.delay} className='flex gap-5 flex-col px-8 py-5 rounded-lg border border-zinc-800 bg-zinc-950 z-10'>
