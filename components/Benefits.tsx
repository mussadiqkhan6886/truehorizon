...
import { aiBenefitsData } from '@/lib/constants'
    ...
    <section className='py-10 text-white'>
      ...
      <div className='grid grid-cols-3 gap-4 px-28'>
        {aiBenefitsData.map(item => (
            <div className='border overflow-hidden border-zinc-800 flex flex-col gap-3 p-6 rounded-md relative' key={item.detail}>
