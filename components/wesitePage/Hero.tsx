      ...
      <div style={{ width: '100%', height: '500px', position: 'absolute' }}>
        ...
        <div className='z-20 sm:px-[35px] md:px-[70px] lg:px-[160px] flex flex-col text-white items-center justify-center min-h-screen'>
            ...
            <div className='px-0 md:px-26 lg:px-50'>
                <TextGenerateEffect className='text-base leading-snug tracking-wide text-center font-normal text-gray-300' duration={1.5} filter={true} words={"We don't offer simple website, We provide full modern design website with faster service"} />
            </div>
