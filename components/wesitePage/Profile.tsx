...
>
  <div className='max-w-[910px]  flex flex-col gap-16 mx-auto'>
    <div className='p-2 md:p-0'>
      <h2 className='text-[27px] sm:text-[35px] md:text-[45px] tracking-tight font-[500] leading-10 md:leading-15'>
    ...
    <div className='flex gap-3 md:gap-13 justify-between items-start'>
      <div className='flex gap-3 items-center'>
        <div className='w-2.5 md:mb-1 h-2 sm:h-2.5 bg-fuchsia-800 rounded-full' />
