...
const Effective = () => {
  return (
    <section id='automations' className='py-10 max-w-[1320px] mx-auto text-white'>
        <Title buttonHeading='Automations' firstLine='Most Effective, Cost' secondLine="And Time Reduction Automations." para='Some of the most effective and cost time reduction automations that are offered by our consultancy.' />
