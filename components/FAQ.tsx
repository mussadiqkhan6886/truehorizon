  ...
  return (
     <section className='py-10 text-white'>
      ...
      <div className='max-w-3xl mx-auto py-16'>
        <div className='relative gap-4 items-center flex justify-center bg-zinc-800/30 overflow-hidden rounded-xl flex-col py-[70px]'>
            <div className='absolute bg-purple-900 -left-[120px] -top-[170px] blur-3xl  opacity-65 w-[300px] h-[340px] rotate-[50deg]' />
            <h6 className='text-5xl text-center font-semibold tracking-tight'>Let AI do the Work so <br />you can Scale Faster</h6>
