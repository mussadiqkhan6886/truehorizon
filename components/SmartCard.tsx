...
const SmartCard = () => {
  return (
    <div className='flex gap-2'>
      <div className='border border-zinc-800 px-0 sm:px-2 w-[120px] sm:w-[180px] flex justify-center items-center flex-col gap-4 h-[160px]'>
        ...
        <h5 className='text-[11px] font-semibold text-center'>Analyze current workflow..</h5>
      </div>
