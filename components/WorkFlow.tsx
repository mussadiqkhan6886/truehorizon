...
const WorkFlow = () => {
  ...
  return (
    <motion.div variants={variants} initial="hidden" whileInView={"show"} viewport={{once: true, amount: 0.2}} className='w-[450px] relative h-[370px] rounded-3xl bg-[#0d0d0dcc] p-[50px] pb-0'>
        <div className='bg-black rounded-2xl border-b-0 p-4 border-zinc-900 h-full border'>
